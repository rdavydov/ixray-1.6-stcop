    ...
    : wxFrame(nullptr, wxID_ANY, title, wxDefaultPosition, wxSize(1280, 1024))
{
    ...
    wxPanel* editPanel = new wxPanel(this, wxID_ANY, wxDefaultPosition, 
        wxSize(260, 1024), wxTAB_TRAVERSAL);
    ...
    wxSizer* editSizer = new wxBoxSizer(wxVERTICAL);
    ...
    selection->Add("Light");
    selection->Add("Sound Source");
    selection->Add("Sound Env");
    selection->Add("Glow");
    selection->Add("Shape");
    selection->Add("Spawn Element");
    selection->Add("Way Points");
    selection->Add("Sector");
    selection->Add("Portal");
    selection->Add("Group");
    selection->Add("Static Particles");
    selection->Add("Detail Objects");
    selection->Add("AI Map");
    selection->Add("Wallmarks");
    selection->Add("Fog Volumes");

    wxRadioBox* radioBox = new wxRadioBox(editPanel, wxID_ANY, wxT("Scene"), wxPoint(20, 20), 
        wxSize(220, 210), *selection, 8, wxRA_SPECIFY_ROWS);

	wxCheckBox* clearSnapList = new wxCheckBox(editPanel, wxID_ANY, wxT("Clear Snap List"), 
        wxDefaultPosition, wxDefaultSize);

	wxListBox* listBox = new wxListBox(editPanel, wxID_ANY, wxPoint(-1, -1), wxSize(220, 210));

    wxPanel* btnPanel = new wxPanel(editPanel, wxID_ANY, wxPoint(-1, -1), wxSize(220, 210));

    /*
    wxButton* btnOne = new wxButton(btnPanel, -1);
    wxButton* btnTwo = new wxButton(btnPanel, -1);
    */

    editSizer->Add(radioBox, 0, wxEXPAND | wxALL, 10);
    editSizer->Add(clearSnapList, 0, wxEXPAND | wxALL, 10);
    editSizer->Add(listBox, 0, wxEXPAND | wxALL, 10);
